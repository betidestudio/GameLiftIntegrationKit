...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API VpcPeeringConnectionStatus();
    AWS_GAMELIFTINTEGRATIONKIT_API VpcPeeringConnectionStatus(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API VpcPeeringConnectionStatus& operator=(Aws::Utils::Json::JsonView jsonValue);
