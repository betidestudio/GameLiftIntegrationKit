...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API MatchmakingRuleSet();
    AWS_GAMELIFTINTEGRATIONKIT_API MatchmakingRuleSet(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API MatchmakingRuleSet& operator=(Aws::Utils::Json::JsonView jsonValue);
