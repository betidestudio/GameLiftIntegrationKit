...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API CertificateConfiguration();
    AWS_GAMELIFTINTEGRATIONKIT_API CertificateConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API CertificateConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
