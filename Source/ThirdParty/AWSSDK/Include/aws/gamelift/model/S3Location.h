...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API S3Location();
    AWS_GAMELIFTINTEGRATIONKIT_API S3Location(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API S3Location& operator=(Aws::Utils::Json::JsonView jsonValue);
