...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API FleetAttributes();
    AWS_GAMELIFTINTEGRATIONKIT_API FleetAttributes(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API FleetAttributes& operator=(Aws::Utils::Json::JsonView jsonValue);
