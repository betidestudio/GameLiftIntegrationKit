...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API FleetCapacity();
    AWS_GAMELIFTINTEGRATIONKIT_API FleetCapacity(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API FleetCapacity& operator=(Aws::Utils::Json::JsonView jsonValue);
