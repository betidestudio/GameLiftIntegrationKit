...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API EC2InstanceCounts();
    AWS_GAMELIFTINTEGRATIONKIT_API EC2InstanceCounts(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API EC2InstanceCounts& operator=(Aws::Utils::Json::JsonView jsonValue);
