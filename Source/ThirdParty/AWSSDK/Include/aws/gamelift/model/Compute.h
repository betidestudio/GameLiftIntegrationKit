...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API Compute();
    AWS_GAMELIFTINTEGRATIONKIT_API Compute(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API Compute& operator=(Aws::Utils::Json::JsonView jsonValue);
