...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API PriorityConfiguration();
    AWS_GAMELIFTINTEGRATIONKIT_API PriorityConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API PriorityConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
