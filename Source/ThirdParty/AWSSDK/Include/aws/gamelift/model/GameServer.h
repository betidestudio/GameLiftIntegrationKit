...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameServer();
    AWS_GAMELIFTINTEGRATIONKIT_API GameServer(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameServer& operator=(Aws::Utils::Json::JsonView jsonValue);
