...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API RuntimeConfiguration();
    AWS_GAMELIFTINTEGRATIONKIT_API RuntimeConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API RuntimeConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
