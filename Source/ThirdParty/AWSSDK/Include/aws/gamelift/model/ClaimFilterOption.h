...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API ClaimFilterOption();
    AWS_GAMELIFTINTEGRATIONKIT_API ClaimFilterOption(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API ClaimFilterOption& operator=(Aws::Utils::Json::JsonView jsonValue);
