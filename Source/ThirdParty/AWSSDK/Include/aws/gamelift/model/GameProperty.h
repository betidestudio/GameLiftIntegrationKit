...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameProperty();
    AWS_GAMELIFTINTEGRATIONKIT_API GameProperty(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameProperty& operator=(Aws::Utils::Json::JsonView jsonValue);
