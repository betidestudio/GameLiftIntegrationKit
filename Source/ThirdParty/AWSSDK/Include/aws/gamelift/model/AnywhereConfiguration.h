...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API AnywhereConfiguration();
    AWS_GAMELIFTINTEGRATIONKIT_API AnywhereConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API AnywhereConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
