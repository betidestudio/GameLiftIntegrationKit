...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API FilterConfiguration();
    AWS_GAMELIFTINTEGRATIONKIT_API FilterConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API FilterConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
