...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API LocationConfiguration();
    AWS_GAMELIFTINTEGRATIONKIT_API LocationConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API LocationConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
