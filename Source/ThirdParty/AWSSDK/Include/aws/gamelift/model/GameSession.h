...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameSession();
    AWS_GAMELIFTINTEGRATIONKIT_API GameSession(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameSession& operator=(Aws::Utils::Json::JsonView jsonValue);
