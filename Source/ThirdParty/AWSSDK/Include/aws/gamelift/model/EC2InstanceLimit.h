...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API EC2InstanceLimit();
    AWS_GAMELIFTINTEGRATIONKIT_API EC2InstanceLimit(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API EC2InstanceLimit& operator=(Aws::Utils::Json::JsonView jsonValue);
