...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API Event();
    AWS_GAMELIFTINTEGRATIONKIT_API Event(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API Event& operator=(Aws::Utils::Json::JsonView jsonValue);
