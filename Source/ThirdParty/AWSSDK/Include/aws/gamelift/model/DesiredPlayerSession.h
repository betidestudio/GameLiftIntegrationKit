...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API DesiredPlayerSession();
    AWS_GAMELIFTINTEGRATIONKIT_API DesiredPlayerSession(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API DesiredPlayerSession& operator=(Aws::Utils::Json::JsonView jsonValue);
