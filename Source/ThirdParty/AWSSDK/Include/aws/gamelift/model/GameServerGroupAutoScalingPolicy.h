...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameServerGroupAutoScalingPolicy();
    AWS_GAMELIFTINTEGRATIONKIT_API GameServerGroupAutoScalingPolicy(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameServerGroupAutoScalingPolicy& operator=(Aws::Utils::Json::JsonView jsonValue);
