...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API TargetConfiguration();
    AWS_GAMELIFTINTEGRATIONKIT_API TargetConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API TargetConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
