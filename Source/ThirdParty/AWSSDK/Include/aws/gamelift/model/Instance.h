...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API Instance();
    AWS_GAMELIFTINTEGRATIONKIT_API Instance(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API Instance& operator=(Aws::Utils::Json::JsonView jsonValue);
