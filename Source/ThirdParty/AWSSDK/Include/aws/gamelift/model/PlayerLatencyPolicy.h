...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API PlayerLatencyPolicy();
    AWS_GAMELIFTINTEGRATIONKIT_API PlayerLatencyPolicy(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API PlayerLatencyPolicy& operator=(Aws::Utils::Json::JsonView jsonValue);
