...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API VpcPeeringConnection();
    AWS_GAMELIFTINTEGRATIONKIT_API VpcPeeringConnection(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API VpcPeeringConnection& operator=(Aws::Utils::Json::JsonView jsonValue);
