...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionQueueDestination();
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionQueueDestination(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionQueueDestination& operator=(Aws::Utils::Json::JsonView jsonValue);
