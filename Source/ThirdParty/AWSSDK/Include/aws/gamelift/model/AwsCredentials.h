...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API AwsCredentials();
    AWS_GAMELIFTINTEGRATIONKIT_API AwsCredentials(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API AwsCredentials& operator=(Aws::Utils::Json::JsonView jsonValue);
