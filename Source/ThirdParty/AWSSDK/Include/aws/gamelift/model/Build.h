...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API Build();
    AWS_GAMELIFTINTEGRATIONKIT_API Build(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API Build& operator=(Aws::Utils::Json::JsonView jsonValue);
