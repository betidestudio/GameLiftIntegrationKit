...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API VpcPeeringAuthorization();
    AWS_GAMELIFTINTEGRATIONKIT_API VpcPeeringAuthorization(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API VpcPeeringAuthorization& operator=(Aws::Utils::Json::JsonView jsonValue);
