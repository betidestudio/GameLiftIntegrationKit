...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionConnectionInfo();
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionConnectionInfo(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionConnectionInfo& operator=(Aws::Utils::Json::JsonView jsonValue);
