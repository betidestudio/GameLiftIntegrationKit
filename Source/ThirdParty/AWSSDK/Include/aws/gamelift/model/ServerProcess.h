...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API ServerProcess();
    AWS_GAMELIFTINTEGRATIONKIT_API ServerProcess(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API ServerProcess& operator=(Aws::Utils::Json::JsonView jsonValue);
