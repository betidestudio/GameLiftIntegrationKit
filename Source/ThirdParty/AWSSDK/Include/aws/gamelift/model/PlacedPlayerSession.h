...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API PlacedPlayerSession();
    AWS_GAMELIFTINTEGRATIONKIT_API PlacedPlayerSession(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API PlacedPlayerSession& operator=(Aws::Utils::Json::JsonView jsonValue);
