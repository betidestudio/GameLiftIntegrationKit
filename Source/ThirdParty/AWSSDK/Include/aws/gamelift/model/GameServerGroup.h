...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameServerGroup();
    AWS_GAMELIFTINTEGRATIONKIT_API GameServerGroup(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameServerGroup& operator=(Aws::Utils::Json::JsonView jsonValue);
