...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API Alias();
    AWS_GAMELIFTINTEGRATIONKIT_API Alias(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API Alias& operator=(Aws::Utils::Json::JsonView jsonValue);
