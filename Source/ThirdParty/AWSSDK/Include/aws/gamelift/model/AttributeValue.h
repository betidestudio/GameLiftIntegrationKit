...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API AttributeValue();
    AWS_GAMELIFTINTEGRATIONKIT_API AttributeValue(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API AttributeValue& operator=(Aws::Utils::Json::JsonView jsonValue);
