...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API IpPermission();
    AWS_GAMELIFTINTEGRATIONKIT_API IpPermission(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API IpPermission& operator=(Aws::Utils::Json::JsonView jsonValue);
