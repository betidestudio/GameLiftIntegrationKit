...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API Script();
    AWS_GAMELIFTINTEGRATIONKIT_API Script(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API Script& operator=(Aws::Utils::Json::JsonView jsonValue);
