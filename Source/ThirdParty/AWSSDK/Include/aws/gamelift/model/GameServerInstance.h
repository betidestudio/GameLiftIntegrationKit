...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameServerInstance();
    AWS_GAMELIFTINTEGRATIONKIT_API GameServerInstance(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameServerInstance& operator=(Aws::Utils::Json::JsonView jsonValue);
