...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API InstanceCredentials();
    AWS_GAMELIFTINTEGRATIONKIT_API InstanceCredentials(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API InstanceCredentials& operator=(Aws::Utils::Json::JsonView jsonValue);
