...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API LocationState();
    AWS_GAMELIFTINTEGRATIONKIT_API LocationState(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API LocationState& operator=(Aws::Utils::Json::JsonView jsonValue);
