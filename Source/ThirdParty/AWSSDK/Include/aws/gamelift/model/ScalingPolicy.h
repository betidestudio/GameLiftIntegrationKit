...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API ScalingPolicy();
    AWS_GAMELIFTINTEGRATIONKIT_API ScalingPolicy(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API ScalingPolicy& operator=(Aws::Utils::Json::JsonView jsonValue);
