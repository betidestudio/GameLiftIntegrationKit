...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API FleetUtilization();
    AWS_GAMELIFTINTEGRATIONKIT_API FleetUtilization(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API FleetUtilization& operator=(Aws::Utils::Json::JsonView jsonValue);
