...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API MatchmakingTicket();
    AWS_GAMELIFTINTEGRATIONKIT_API MatchmakingTicket(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API MatchmakingTicket& operator=(Aws::Utils::Json::JsonView jsonValue);
