...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API LocationModel();
    AWS_GAMELIFTINTEGRATIONKIT_API LocationModel(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API LocationModel& operator=(Aws::Utils::Json::JsonView jsonValue);
