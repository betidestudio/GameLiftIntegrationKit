...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionQueue();
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionQueue(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionQueue& operator=(Aws::Utils::Json::JsonView jsonValue);
