...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API TargetTrackingConfiguration();
    AWS_GAMELIFTINTEGRATIONKIT_API TargetTrackingConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API TargetTrackingConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
