...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API Tag();
    AWS_GAMELIFTINTEGRATIONKIT_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
