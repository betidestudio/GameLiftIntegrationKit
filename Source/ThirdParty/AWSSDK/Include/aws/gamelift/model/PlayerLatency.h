...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API PlayerLatency();
    AWS_GAMELIFTINTEGRATIONKIT_API PlayerLatency(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API PlayerLatency& operator=(Aws::Utils::Json::JsonView jsonValue);
