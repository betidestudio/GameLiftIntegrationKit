...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionDetail();
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionDetail(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
