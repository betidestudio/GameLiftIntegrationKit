...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API MatchedPlayerSession();
    AWS_GAMELIFTINTEGRATIONKIT_API MatchedPlayerSession(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API MatchedPlayerSession& operator=(Aws::Utils::Json::JsonView jsonValue);
