...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionPlacement();
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionPlacement(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API GameSessionPlacement& operator=(Aws::Utils::Json::JsonView jsonValue);
