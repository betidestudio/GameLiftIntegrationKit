...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API Player();
    AWS_GAMELIFTINTEGRATIONKIT_API Player(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API Player& operator=(Aws::Utils::Json::JsonView jsonValue);
