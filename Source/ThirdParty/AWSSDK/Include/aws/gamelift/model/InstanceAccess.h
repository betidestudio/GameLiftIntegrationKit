...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API InstanceAccess();
    AWS_GAMELIFTINTEGRATIONKIT_API InstanceAccess(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API InstanceAccess& operator=(Aws::Utils::Json::JsonView jsonValue);
