...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API LaunchTemplateSpecification();
    AWS_GAMELIFTINTEGRATIONKIT_API LaunchTemplateSpecification(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API LaunchTemplateSpecification& operator=(Aws::Utils::Json::JsonView jsonValue);
