...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API LocationAttributes();
    AWS_GAMELIFTINTEGRATIONKIT_API LocationAttributes(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API LocationAttributes& operator=(Aws::Utils::Json::JsonView jsonValue);
