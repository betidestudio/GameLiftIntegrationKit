...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API MatchmakingConfiguration();
    AWS_GAMELIFTINTEGRATIONKIT_API MatchmakingConfiguration(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API MatchmakingConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API Aws::Utils::Json::JsonValue Jsonize() const;
     ...
     * This parameter is not used when <code>FlexMatchMode</code> is set to
