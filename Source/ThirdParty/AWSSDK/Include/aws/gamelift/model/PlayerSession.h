...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API PlayerSession();
    AWS_GAMELIFTINTEGRATIONKIT_API PlayerSession(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API PlayerSession& operator=(Aws::Utils::Json::JsonView jsonValue);
