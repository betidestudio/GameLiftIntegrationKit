...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API InstanceDefinition();
    AWS_GAMELIFTINTEGRATIONKIT_API InstanceDefinition(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API InstanceDefinition& operator=(Aws::Utils::Json::JsonView jsonValue);
