...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API RoutingStrategy();
    AWS_GAMELIFTINTEGRATIONKIT_API RoutingStrategy(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API RoutingStrategy& operator=(Aws::Utils::Json::JsonView jsonValue);
