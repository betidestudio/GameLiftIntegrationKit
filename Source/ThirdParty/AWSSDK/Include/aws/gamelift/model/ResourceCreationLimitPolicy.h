...
namespace Model
{
  ...
  {
  public:
    AWS_GAMELIFTINTEGRATIONKIT_API ResourceCreationLimitPolicy();
    AWS_GAMELIFTINTEGRATIONKIT_API ResourceCreationLimitPolicy(Aws::Utils::Json::JsonView jsonValue);
    AWS_GAMELIFTINTEGRATIONKIT_API ResourceCreationLimitPolicy& operator=(Aws::Utils::Json::JsonView jsonValue);
